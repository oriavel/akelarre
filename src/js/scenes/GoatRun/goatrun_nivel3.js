...
export default class GoatRun_Nivel3 extends BaseGoatRun {
	...
	*/
    ...
    winScreen(){
        ...
        //El texto
        this.text2 = this.add.text(this.graphics2.x + 235, this.graphics2.y+20, "Escapaste de la cabra!", { font: "24px Arial", fill: "#ffffff" });
        this.text3 = this.add.text(this.graphics2.x + 165, this.graphics2.y+60, "Pulse Enter para volver a la cueva", { font: "24px Arial", fill: "#ffffff" });
        this.restart = true;
    }
