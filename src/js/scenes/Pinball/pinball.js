...
export default class Pinball extends Phaser.Scene {
  ...
  initPhysics() {
    ...
    this.leftFlipper = new Flipper(this, 260, 500, "left");
    this.rightFlipper = new Flipper(this, 550, 500, "right");
    ...
    // walls
    this.wallLeft = new Wall(this, 150, 270, -0.3);
    this.wallRight = new Wall(this, 660, 270, 0.3);
  }
